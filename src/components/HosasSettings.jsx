...
export function HosasSettings({ config, applyChanges, handleHosasModeChange }) {
  ...
  const [hosasOpen, setHosasOpen] = useState(true);
    ...
    <>
      ...
      <section className="panel">
        <div className="section-header">
          <h2>Calibration</h2>
          <button type="button" onClick={() => setCalibrationOpen(!calibrationOpen)}>
      ...
      <section className="panel">
        <div className="section-header">
          ...
          <button type="button" onClick={() => setHosasOpen(!hosasOpen)}>
            {hosasOpen ? "Collapse" : "Expand"}
          </button>
        </div>
        {hosasOpen && (
          <>
      ...
      <section className="panel">
        <div className="section-header">
          ...
          <button type="button" onClick={() => setReverseOpen(!reverseOpen)}>
            {reverseOpen ? "Collapse" : "Expand"}
          </button>
        </div>
        {reverseOpen && (
          <>
